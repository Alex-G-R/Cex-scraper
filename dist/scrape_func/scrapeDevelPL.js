...
exports.start_scraping_devel_pl = void 0;
const puppeteer = require('puppeteer-extra');
const pluginStealth = require('puppeteer-extra-plugin-stealth');
const fs = require('fs').promises;
const ps3gamesPL_1 = require("../links/ps3gamesPL");
const scrape_utils_1 = require("../common/scrape_utils");
async function start_scraping_devel_pl(page_param) {
    ...
    try {
        await page.goto(ps3gamesPL_1.link_array[page_index], { waitUntil: 'domcontentloaded' });
        console.log(ps3gamesPL_1.link_array[page_index]);
        ...
        fs.appendFile(pathPS3, `${ps3gamesPL_1.link_array[page_index]} \n`)
            .then(() => {
        })
            .catch((error) => {
...
exports.start_scraping_devel_pl = start_scraping_devel_pl;
//# sourceMappingURL=scrapeDevelPL.js.map