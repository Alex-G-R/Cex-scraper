...
exports.start_scraping_pl_ps3 = void 0;
...
async function start_scraping_pl_ps3() {
    for (let i = 0; i < ps3gamesPL_1.link_array.length; i++) {
        ...
        try {
            await page.goto(ps3gamesPL_1.link_array[i], { waitUntil: 'domcontentloaded' });
            console.log(ps3gamesPL_1.link_array[i]);
            ...
            fs.appendFile(pathPS3, `${ps3gamesPL_1.link_array[i]} \n`)
                .then(() => {
            })
                .catch((error) => {
