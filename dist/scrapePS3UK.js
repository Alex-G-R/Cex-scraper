...
exports.checkRobotsTxtUKPS3 = exports.start_scraping_uk_ps3 = void 0;
...
async function start_scraping_uk_ps3() {
    for (let i = 0; i < ps3gamesUK_1.link_array_UK.length; i++) {
        ...
        try {
            await page.goto(ps3gamesUK_1.link_array_UK[i], { waitUntil: 'domcontentloaded' });
            console.log(ps3gamesUK_1.link_array_UK[i]);
            ...
            fs.appendFile(pathPS3, `${ps3gamesUK_1.link_array_UK[i]} \n`)
                .then(() => {
            })
                .catch((error) => {
