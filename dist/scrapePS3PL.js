...
exports.checkRobotsTxtPLPS3 = exports.start_scraping_pl_ps3 = void 0;
const puppeteer = require('puppeteer-extra');
const pluginStealth = require('puppeteer-extra-plugin-stealth');
const fs = require('fs').promises;
const ps3games_1 = require("./links/ps3games");
const pathPS3 = "data/ps3PL.txt";
async function start_scraping_pl_ps3() {
    for (let i = 0; i < ps3games_1.link_array.length; i++) {
        ...
        try {
            await page.goto(ps3games_1.link_array[i], { waitUntil: 'domcontentloaded' });
            console.log(ps3games_1.link_array[i]);
            ...
            fs.appendFile(pathPS3, `${ps3games_1.link_array[i]} \n`)
                .then(() => {
            })
                .catch((error) => {
...
exports.start_scraping_pl_ps3 = start_scraping_pl_ps3;
async function checkRobotsTxtPLPS3(page) {
...
exports.checkRobotsTxtPLPS3 = checkRobotsTxtPLPS3;
//# sourceMappingURL=scrapePS3PL.js.map